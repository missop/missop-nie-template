...
function getTagNamespace (tag) {
  ...
  // znode it doesn't support other MathML elements being component roots
  if (tag === 'math') {
    return 'math'
  }
}
...
function createPatchFunction (backend) {
  ...
  function patchVnode (oldVnode, vnode, insertedVnodeQueue, removeOnly) {
    ...
    // znode we only do this if the vnode is cloned -
...
function genFor (el) {
  ...
  if (
    ...
    warn$3(
      ...
      "See https://vuejs.org/guide/list_news.html#key for more info.",
      true /* tip */
    );
  }
